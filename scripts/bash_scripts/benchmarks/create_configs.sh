...
# predictors
# predictors=(min_depth)   #(fisher grad_norm grasp jacov snip synflow epe_nas flops params plain l2_norm nwot zen)
...
--start_seed $i --out_dir $out_dir --dataset=$dataset \
