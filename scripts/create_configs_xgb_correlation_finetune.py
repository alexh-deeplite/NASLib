...
def main(args):
    ...
    for i in range(args.start_seed, args.start_seed + args.trials):
        config = {
            ...
            'test_train_size': args.test_train_size,
        ...
        with open(folder + f'/config_{i}.yaml', 'w') as fh:
            yaml.dump(config, fh)
    print('writing config to ', folder + f'/config_{i}.yaml')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_train_size", type=int, default=42, help="Which dataset")
